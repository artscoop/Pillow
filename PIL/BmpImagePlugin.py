...
class BmpImageFile(ImageFile.ImageFile):
    ...
    def _bitmap(self, header=0, offset=0):
        ...
        # Special case : header is reported 40, which is shorter than real size for bpp >= 16
        ...
        self.mode, raw_mode = BIT2MODE.get(file_info['bits'], None) or (None, None)
...
class DibImageFile(BmpImageFile):
    ...
    def _open(self):
        """ Opens DIB file. See BMPImageFile. """
        self._bitmap()
